    ...
    return (
        <ParallaxProvider>
            <div className="font-sans text-primary bg-white overflow-x-hidden" ref={containerRef}>
                    ...
                    >
                        ...
                        >
                            ...
                            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-4 sm:mb-6 leading-tight drop-shadow-lg">
                                Live <span className="text-fourth drop-shadow-md">Outside</span> The Box
                            </h1>
                        ...
                        <div className="container mx-auto px-4 sm:px-6">
                            ...
                            >
                                ...
                                <div className="grid md:grid-cols-1 gap-8 sm:gap-12 items-center">
                                    ...
                                    >
                                        <p>
                                            <span className="font-bold">Outbox is a lifestyle brand</span> founded on the belief that life is meant to be lived <span className="text-fourth font-medium">outside the box</span> — boldly, creatively, and without limits.
                                        </p>
                                        ...
                                        <p>
                                            More than a brand, Outbox is a <span className="font-medium">mindset</span> — a movement for those who dare to live <span className="text-fourth font-medium">fully and fearlessly</span>.
                                        </p>
                                    </motion.div>
                                </div>
                            </motion.div>
                        ...
                        <div className="max-w-6xl mx-auto">
                            ...
                            >
                                <h2 className="text-4xl sm:text-5xl font-bold text-white text-center mb-6">
                                    <Header content={"Our Logo Story"} background={"bg-white"} text={"text-white"} />
                                </h2>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                    {[
                                        ...
                                        >
                                            ...
                                            <p className="text-primary leading-relaxed">{item.desc}</p>
                                        </motion.div>
                                    ))}
                                </div>
                            </motion.div>
                ...
                {/* Community Section*/}
                <section id="community" className="py-24 sm:py-32 bg-third relative overflow-hidden">
                    <motion.div
                        style={{ y: y1 }}
                    ...
                    <div className="container mx-auto px-4 sm:px-6 relative z-10">
                        <div className="grid md:grid-cols-2 gap-12 sm:gap-16 items-center">
                            ...
                            >
                                <Header content={"The OutBox Community"} text="text-white" background={"bg-white"} />
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <div className="absolute inset-0 w-full h-full">
                                                        ...
                                                        />
                                                        <div className={`absolute inset-0 ${bgColorClass} bg-opacity-80`}></div>
                                                    </div>
                                                    ...
                                                    <div className="relative h-full w-full flex flex-col justify-end p-6 z-10">
                                                        ...
                                                        <motion.div
                                                            variants={{
                                                                rest: { opacity: 0, y: 40, pointerEvents: "none" },
                                                                hover: { opacity: 1, y: -20, pointerEvents: "auto" }
                                                            }}
                                                            transition={{ duration: 0.3 }}
                                                            className="absolute left-0 bottom-20 w-full px-6"
                                                        >
                                                            <p className={`mb-3 text-base leading-relaxed ${textColor}`}>{cat.shortDescription}</p>
                                                            <ul className={`space-y-2 text-base leading-relaxed ${textColor}`}>
